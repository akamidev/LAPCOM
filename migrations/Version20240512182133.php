 ...
 */
final class Version20240512182133 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE isHomepage is_homepage TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE is_homepage isHomepage TINYINT(1) DEFAULT NULL');
    }
}
